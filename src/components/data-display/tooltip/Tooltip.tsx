    ...
    >
      ...
      {visible && <HoloPortal>
        <div
          ...
          role="tooltip"
          className={`
            shd-z-tooltip shd-scrollbar box-border max-h-[calc(100vh-16px)] max-w-[calc(100vw-16px)] overflow-auto px-2 py-1 text-xs text-content-primary whitespace-normal break-words
