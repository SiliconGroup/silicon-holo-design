        ...
        <HoloPortal>
          <div
            ...
            className={`
              ...
              shd-z-nested-overlay shd-scrollbar box-border max-h-[calc(100vh-16px)] max-w-[calc(100vw-16px)] overflow-auto rounded-md p-1 min-w-32 shadow-[0_16px_40px_rgba(0,0,0,0.32)]
            `}
            style={(() => {
