  ...
  build: {
    lib: {
      entry: {
        ...
        'components/studio/index': resolve(__dirname, 'src/components/studio/index.ts'),
        'components/studio/editor/index': resolve(__dirname, 'src/components/studio/editor/index.ts'),
